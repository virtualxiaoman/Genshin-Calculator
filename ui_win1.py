...
class Window1(QWidget):
    ...
    def init_damage_ui(self):
        ...
        font_english_TNR12Bold = QFont("Times New Roman", 12)
        font_english_TNR12Bold.setBold(True)
        ...
        self.label_AE.setFont(font_english_TNR12Bold)
        self.label_AE.setStyleSheet("color: red;")
        ...
        self.label_DB.setFont(font_english_TNR12Bold)
        self.label_DB.setStyleSheet("color: red;")
        ...
        self.label_CD.setFont(font_english_TNR12Bold)
        self.label_CD.setStyleSheet("color: red;")
        ...
        self.label_ER.setFont(font_english_TNR12Bold)
        ...
        self.label_DF.setFont(font_english_TNR12Bold)
        self.label_DF.setStyleSheet("color: red;")
        ...
        self.label_RT.setFont(font_english_TNR12Bold)
        self.label_RT.setStyleSheet("color: red;")
